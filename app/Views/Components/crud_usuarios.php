...
<div class="container">
    ...
    <div class="form-floating mb-3">
        <div class="input-group">
            <input type="password" name="password_edit" class="form-control" id="password_edit" placeholder="Nueva Contraseè´–a">
                ...
                <div class="modal fade" id="eliminarUsuarioModal<?= $user['user_id'] ?>" tabindex="-1" aria-labelledby="eliminarUsuarioModalLabel<?= $user['user_id'] ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>è¢ƒEstè´° seguro de que desea eliminar este usuario?</p>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('crud_usuarios/agregar') ?>" class="was-validated" method="post">
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-floating">Contraseè´–a:</label>
                            <div class="input-group">
